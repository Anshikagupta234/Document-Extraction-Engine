...
Tech Stack
Backend APIPython 3.10 + FastAPIAI Model + Google Gemini 2.5 Flash +PDF Parsingpdfplumber + PyMuPDFImage + OCRGemini Vision APIValidationPydantic v2StorageJSON filesFrontendStreamlitExportpandas + openpyxl
